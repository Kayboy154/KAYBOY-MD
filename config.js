...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "kayboy_md-iIdnRApT#0u5WhUuWpBtDtGP7YfJsWCdx0XkvXLG6AN9kGYoHvEw",
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "true",
MODE: process.env.MODE || "private",
OWNER_NUMBER: process.env.OWNER_NUMBER || "263776509966",
OWNER_NAME: process.env.OWNER_NAME || "KAYBOY",
...
MENU_IMG: process.env.MENU3_IMG || "https://https://files.catbox.moe/v13b54.jpg",
...
BOT_NAME: process.env.BOT_NAME || "𝙆𝘼𝙔𝘽𝙊𝙔-𝙈𝘿",
